...
var img_base=base+skin+'/image/';
//******** END QV *********

var dhtmlwindow={
imagefiles:[img_base+'w_min.gif', img_base+'w_close.gif', img_base+'w_restore.gif', img_base+'w_resize.gif'], //Path to 4 images used by script, in that order
