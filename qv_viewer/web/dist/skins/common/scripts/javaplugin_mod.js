...
if(_info.indexOf("Opera")>=0){
  ...
  _ns = (navigator.appName.indexOf("Netscape") >= 0 && ((_info.indexOf("Win") > 0 && _info.indexOf("Win16") < 0 /*&& java.lang.System.getProperty("os.version").indexOf("3.5") < 0*/) ||
(_info.indexOf("Sun") > 0) || (_info.indexOf("Linux") > 0) || (_info.indexOf("AIX") > 0) || (_info.indexOf("OS/2") > 0)));
...
function writeDownloadPageInfo(){
  document.writeln(
    '<SPAN STYLE="background-color: #F5DEB3; color: Black; display: block; padding: 10; font-family: Verdana,Arial; border-style: solid; border-width: thin; font-size: 12px; text-align: center; font-
weight: bold;">'+
    'Per utilitzar aquesta aplicaci&oacute; cal instal&middot;lar el plug-in Java&#153; 1.3.1<BR><A HREF="http://www.xtec.es/recursos/clic/jclic/instal_plugin.htm" TARGET="_blank">Feu clic
aqu&iacute; per descarregar-lo</A><BR>&nbsp;<BR>'+
    'Para utilizar esta aplicaci&oacute;n hay que instalar el plug-in Java&#153; 1.3.1<BR><A HREF="http://www.xtec.es/recursos/clic/jclic/instal_plugin_esp.htm" TARGET="_blank">Haga clic aqu&iacute;
para descargarlo</A><BR>&nbsp;<BR>'+
    'In order to run this program you need to install the Java&#153; plug-in 1.3.1<BR><A HREF="http://www.xtec.es/recursos/clic/jclic/instal_plugin_eng.htm" TARGET="_blank">Click here to download
it</A><BR>'+
    '</SPAN>');
}
