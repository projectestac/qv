				...
				try{
					...
					while (!end){
						...
						if(returnVal == JFileChooser.APPROVE_OPTION) {
							...
							if (!canWrite){
								JOptionPane.showMessageDialog(main2, "No es té accés per escriure en aquesta carpeta. Tria'n una altre.", "Tria on vols desar les proves i els resultats", JOptionPane.ERROR_MESSAGE); 
							} else {
