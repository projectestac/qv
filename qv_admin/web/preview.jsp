...
<tr>
	<td><input type="radio" name="tipus_qv" value="xml" <%=QVPreviewBean.TIPUS_XML.equals(qvb.getTipus())?"checked":""%>  onclick="disable(this.value);">Adreça del quadern</td>
</tr>
<tr>
	<td style="padding-left:50px">
		<table border="0" cellpadding="0" cellspacing="0">
...
<table border="0" cellpadding="2" cellspacing="0" class="box" width="100%">
<tr>
	<td><input type="radio" name="p_target" value="_self" <%=(qvb.getTarget()==null || QVPreviewBean.TARGET_SELF.equals(qvb.getTarget()))?"checked":""%> onclick="disableControl('target', true);">El Quadern Virtual ocupa tota la pàgina</td>
</tr>
<tr>
	<td><input type="radio" name="p_target" value="" <%=QVPreviewBean.TARGET_BLANK.equals(qvb.getTarget())?"checked":""%>  onclick="disableControl('target', false);">Enllaç al Quadern Virtual que s'obre en una finestra nova</td>
</tr>
<tr>
	<td style="padding-left:22px">
		...
		<tr>
			...
			<td><input type="text" size="65" name="p_page_title" title="Títol de la pàgina" <%=QVPreviewBean.TARGET_BLANK.equals(qvb.getTarget())?"":"DISABLED"%>></textarea></td>
		</tr>
		<tr>
			<td valign="top">Codi HTML previ:&nbsp;</td>
			<td><textarea cols="57" rows="3" name="p_previous_text" title="Text previ a l'enllaç del quadern" <%=QVPreviewBean.TARGET_BLANK.equals(qvb.getTarget())?"":"DISABLED"%>></textarea></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><textarea cols="57" rows="3" name="p_next_text" title="Text posterior a l'enllaç del quadern" <%=QVPreviewBean.TARGET_BLANK.equals(qvb.getTarget())?"":"DISABLED"%>></textarea></td>
		</tr>
		</table>
	</td>
</tr>
