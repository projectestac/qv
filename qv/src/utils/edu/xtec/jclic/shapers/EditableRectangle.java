/*
 * EditableRectangle.java
 *
 * Created on 26 / febrer / 2002, 13:32
 */
...
public class EditableRectangle extends Rectangle2D.Double implements EditableShape, Cloneable{
    ...
    public EditableShape[] divide(double x, double y) { //Deixarà de ser un Rectangle. Retornem un array amb 5 linies
        return divide(x, y, true);
    }
    
    public EditableShape[] divide(double x, double y, boolean newPoint){
        //Retornem un array amb les noves línies del Rectangle. Si newPoint=true partim la recta que conté (x,y)
    ...
    public void aproximateNearestBorder(double x, double y) {
        ...
        boolean b=hasClickedBorder(x,y,false); //Marca la cantonada més propera
        changeBorder(x,y); //Posa la cantonada mes propera a (x,y) en la posició (x,y)
    }
