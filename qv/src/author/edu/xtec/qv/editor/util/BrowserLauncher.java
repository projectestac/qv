...
public class BrowserLauncher {
    ...
    private static final String THIRD_WINDOWS_PARAMETER = "\"iexplore\"";
	...
	private static Object locateBrowser() {
		...
		switch (jvm) {
			...
			case MRJ_3_1:
				...
				break;
			case WINDOWS_NT:
				//System.out.println("w_nt");
				browser = "cmd.exe";
				break;
			case WINDOWS_9x:
				//System.out.println("w_9x");
				browser = "command.com";
				break;
			case OTHER:
			default:
	...
	public static void openURL(String url) throws IOException {
		...
		switch (jvm) {
		    ...
		    case WINDOWS_NT:
		    case WINDOWS_9x:
		    	//System.out.println("CASE_WINDOWS_9x b:"+(String)browser+" f:"+FIRST_WINDOWS_PARAMETER+" s:"+SECOND_WINDOWS_PARAMETER+" t:"+THIRD_WINDOWS_PARAMETER+" <--");
