...
<!-- #################### INDEX ################# -->
 ...
 <table cellspacing="0" cellpadding="0" width="629" border="0" height="68">
   <tr>
     <td bgcolor="#6666CC"><img alt="Materials per a la integració de les TIC al currículum" width="148" height="69" border="0" align="left"><xsl:attribute name="src"><xsl:value-of select="$specific_images_path"/>/logo.gif</xsl:attribute></img></td>
