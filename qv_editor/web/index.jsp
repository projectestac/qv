...
%>
	<TR>
        ...
        <TD>&nbsp;&nbsp;&nbsp;</TD>
        <TD>
			<A href="#" onclick="open_popup('../../qv/preview.jsp?p_select_qv=false&p_username=<%=qvb.getUserId()%>&p_quadern=<%=quaderns[i]%>&p_skin=<%=qvb.getDefaultSkin()%>','HTML','700','500');" class="index-link" title="Generador de pàgines web">HTML</A>        
        </TD>
	</TR>
<%
	}
...
<TR>
  ...
  <TD>
	<TABLE border='0' cellpadding='3' cellspacing='0' width="100%">
	<TR>
	  	<TD class="index-text" align="right" style="font-size:9" title="qv@xtec.net" ><%=qvb.getMsg("msg.index.contact_info")%> <A href="mailto:qv@xtec.net" class="index-link" style="font-size:11;font-weight:bold;text-decoration:none;">qv@xtec.net</A></TD
	</TR>
	</TABLE>
  </TD>
  <TD height='50%' width='50'></TD>
